...
const Contact = () => {
  ...
  return (
    <section
      id="contact"
      className={`w-full min-h-screen px-6 py-24 relative overflow-hidden flex items-center justify-center transition-colors duration-300 ${
        isLight ? "bg-[#f8fafc] text-slate-900" : "bg-gradient-to-b from-[#09090F] via-[#10131D] to-[#09090F] text-white"
      }`}
    >
      ...
      <div className="max-w-6xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <h1
            className={`text-4xl md:text-5xl font-black max-w-2xl mx-auto leading-tight ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div
            ...
            className={`md:col-span-5 rounded-3xl p-6 md:p-8 flex flex-col justify-between gap-6 cursor-default relative overflow-hidden transition-all duration-300 ${
              isLight
                ? "bg-white border border-slate-200/90 shadow-md text-slate-800"
                : "bg-white/[0.03] border border-white/10 shadow-2xl text-white backdrop-blur-xl"
            }`}
          >
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <p className={`text-xs font-mono ${
                    isLight ? "text-purple-700 font-semibold" : "text-purple-400"
              ...
              {/* Bio description */}
              <p className={`text-xs md:text-sm leading-relaxed border-t pt-4 ${
                isLight ? "border-slate-200 text-slate-600" : "border-white/5 text-gray-300"
              }`}>
                ...
                <span className={`block mt-2 ${isLight ? "text-slate-500" : "text-gray-400"}`}>
              ...
              <div className="flex flex-col gap-2.5 mt-2">
                {contactItems.map((item, i) => (
                  ...
                  >
                    ...
                    <div>
                      <p className={`text-[9px] uppercase font-mono tracking-widest ${
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className={`p-4 rounded-2xl border ${
                ...
                <p className={`mt-2 text-[10px] font-mono uppercase tracking-widest ${
                  isLight ? "text-purple-800" : "text-gray-500"
                }`}>— Prashant Jha</p>
              </div>
          ...
          <motion.div
            ...
            whileHover={{ y: -8, scale: 1.02 }}
            transition={{ type: "spring", stiffness: 300, damping: 20 }}
            className={`md:col-span-7 rounded-3xl p-6 md:p-8 flex flex-col justify-center relative overflow-hidden transition-all duration-300 ${
              isLight
                ? "bg-white border border-slate-200/90 shadow-md text-slate-800"
                : "bg-white/[0.03] border border-white/10 shadow-2xl text-white backdrop-blur-xl"
            }`}
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5 relative z-10">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="name" className={`text-[10px] uppercase font-mono tracking-widest ${
                    isLight ? "text-slate-600 font-semibold" : "text-gray-400"
                  }`}>Full Name</label>
                  <input
                    type="text"
                    id="name"
                    ...
                    required
                    className={`w-full mt-2 px-4 py-3 rounded-xl border text-sm outline-none transition-all ${
                      isLight
                        ? "bg-slate-50 border-slate-300 text-slate-900 placeholder:text-slate-400 focus:bg-white focus:border-blue-500"
                        : "bg-black/30 border-white/10 text-white placeholder:text-gray-600 focus:border-purple-500"
                    }`}
                  />
                </div>
                <div>
                  <label htmlFor="email" className={`text-[10px] uppercase font-mono tracking-widest ${
                    isLight ? "text-slate-600 font-semibold" : "text-gray-400"
                  }`}>Email Address</label>
                  <input
                    type="email"
              ...
              {/* Subject Input Field */}
              <div>
                <label htmlFor="subject" className={`text-[10px] uppercase font-mono tracking-widest ${
                  isLight ? "text-slate-600 font-semibold" : "text-gray-400"
                }`}>Subject</label>
                <input
                  type="text"
              ...
              {/* Message Input Field */}
              <div>
                <label htmlFor="message" className={`text-[10px] uppercase font-mono tracking-widest ${
                  isLight ? "text-slate-600 font-semibold" : "text-gray-400"
                }`}>Message</label>
                <textarea
                  id="message"
                  ...
                  required
                  className={`w-full mt-2 px-4 py-3 rounded-xl border text-sm outline-none transition-all resize-none ${
                    isLight
                      ? "bg-slate-50 border-slate-300 text-slate-900 placeholder:text-slate-400 focus:bg-white focus:border-blue-500"
                      : "bg-black/30 border-white/10 text-white placeholder:text-gray-600 focus:border-purple-500"
                  }`}
              ...
              <button
                ...
                className="w-full py-3.5 rounded-full font-medium text-sm text-white transition-all duration-500 relative overflow-hidden group cursor-pointer shadow-md"
                style={{
              ...
              <AnimatePresence>
                {status === "success" && (
                  <motion.p 
                    ...
                    exit={{ opacity: 0 }}
                    className="text-xs text-emerald-600 dark:text-emerald-400 text-center font-medium font-mono mt-1"
                  >
                ...
                {status === "error" && (
                  <motion.p 
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    exit={{ opacity: 0 }}
                    className="text-xs text-rose-600 dark:text-rose-400 text-center font-medium font-mono mt-1"
                  >
      ...
      {/* Footer */}
      <div className={`absolute bottom-0 left-0 right-0 py-6 border-t backdrop-blur-md hidden md:block transition-colors duration-300 ${
        isLight
          ? "bg-white/90 border-slate-200 text-slate-600"
          : "bg-black/10 border-white/5 text-gray-500"
      }`}>
        <div className="max-w-6xl mx-auto flex justify-between items-center px-6 text-[11px] font-mono uppercase tracking-wider">
          <div className="flex items-center gap-4">
            <p>© 2026 Prashant Jha</p>
            <span className={`text-[10px] font-mono font-normal ${
              isLight ? "text-purple-700" : "text-purple-400/80"
            }`}>
